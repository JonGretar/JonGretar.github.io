...
tuesdata <- readRDS("../2021-12-20-deforestation/deforestation.data")
```
...
![GDPR fines per capita © David Sjoberg](ranking_gdpr.png)
...
```{r map_final, layout="l-body-outset", preview=TRUE}
ggplot(line_data) +
  geom_sf(data=map, color="lightblue1", fill="forestgreen") +
